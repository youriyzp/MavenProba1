package net.ukr.kiyashko.lab7_1;

import net.ukr.kiyashko.lab7_1.inheritance.animals.Animal;
import net.ukr.kiyashko.lab7_1.inheritance.animals.Cat;
import net.ukr.kiyashko.lab7_1.inheritance.animals.Dog;
import net.ukr.kiyashko.lab7_1.inheritance.compose.TestA;
import net.ukr.kiyashko.lab7_1.inheritance.compose.TestB;
import net.ukr.kiyashko.lab7_1.inheritance.devices.Pad;
import net.ukr.kiyashko.lab7_1.inheritance.devices.SmartPhone;
import net.ukr.kiyashko.lab7_1.polymorphism.Simple;
import net.ukr.kiyashko.lab7_1.polymorphism.Specific;
